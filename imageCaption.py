...
@app.route('/')
def index():
    return render_template('imagecapt.html')
...
def predict_caption_route():
    ...
    if file:
        ...
        return render_template('imagecapt.html', image_file=file_path, conditional_caption=conditional_caption, unconditional_caption=unconditional_caption)
